...
<section>
	<div class="container container--flex-start">
		...
		<aside class="aside aside--pulled-up-default">
			<?php include('inc/info-block-slim.php') ?>

			<div class="aside__link-block">
		...
		<div class="content">
			<div class="category-label category-label--b">Pediatrics</div>
			<h1>UAMS Department of Pediatrics</h1>
