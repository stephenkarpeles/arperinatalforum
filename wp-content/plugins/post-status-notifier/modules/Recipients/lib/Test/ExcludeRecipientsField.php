 ...
 * @version   $Id: ExcludeRecipientsField.php 472 2017-04-02 10:21:00Z timoreithde $
 * @package   
 */ 
class Psn_Module_Recipients_Test_ExcludeRecipientsField implements IfwPsn_Wp_Plugin_Selftest_Interface
{
    ...
    {
        return __('Exclude recipients field', 'psn_rec');
    }
    ...
    {
        if ($this->_dbPatcher->isFieldExcludeRecipients()) {
            $this->_result = true;
        }
    }
    ...
    {
        $this->_dbPatcher->createRulesFieldExcludeRecipients();
