 ...
 * @version  $Id: Manager.php 1850577 2018-03-31 19:25:01Z worschtebrot $
 */
class IfwPsn_Wp_Widget_Manager
{
    ...
    {
        return add_action('widgets_init', create_function('', 'return register_widget("'. $widget_classname .'");'));
    }
