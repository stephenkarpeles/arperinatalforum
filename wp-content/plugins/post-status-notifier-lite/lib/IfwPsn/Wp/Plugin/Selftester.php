 ...
 * @version   $Id: Selftester.php 1850577 2018-03-31 19:25:01Z worschtebrot $
...
class IfwPsn_Wp_Plugin_Selftester 
{
    ...
    protected function _skipAutorun()
    {
        ...
        if ($updateManager instanceof IfwPsn_Wp_Plugin_Update_Manager && $updateManager->getPatcher()->isPatchesAvailable()) {
            return true;
        }
