 ...
 * @version  $Id: Plugin.php 1850577 2018-03-31 19:25:01Z worschtebrot $
 */
...
class IfwPsn_Wp_Env_Plugin extends IfwPsn_Wp_Env_Abstract
{
    ...
    {
        if (IfwPsn_Wp_Server_Php::versionIsGreaterOrEqual('7')) {
            return $this->_phpSapiName == 'cli';
        } else {
            return $this->_phpSapiName == 'cli' || isset($_ENV['SHELL']);
        }
    }
