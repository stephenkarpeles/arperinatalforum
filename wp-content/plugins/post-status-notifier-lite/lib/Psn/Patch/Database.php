 ...
 * @version   $Id: Database.php 1850577 2018-03-31 19:25:01Z worschtebrot $
 * @package   
 */ 
class Psn_Patch_Database implements IfwPsn_Wp_Plugin_Update_Patch_Interface
{
    ...
    {
        // ALTER TABLE `wp_psn_rules` ADD `post_whitelist` TEXT NULL;
    ...
    {
        // ALTER TABLE `wp_psn_rules` ADD `post_blacklist` TEXT NULL;
    ...
    {
        // ALTER TABLE `wp_psn_rules` ADD `exclude_recipients` TEXT NULL;
    ...
    {
        // ALTER TABLE `wp_psn_rules` ADD `dyn_match` TEXT NULL;
